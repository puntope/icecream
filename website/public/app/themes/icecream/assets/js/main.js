...
/******/ 	__webpack_require__.p = "/wp-content/themes/icecream/";
/******/
/******/
...
function initForm() {
  ...
  var next = form.querySelectorAll('.js-submit-next');
  var ctaForm = document.querySelector('.js-cta-form');
  var emailInput = form.querySelector('input[name="email"]');
  var emailInputCta = ctaForm.querySelector('input[name="email"]');
  ...
  document.addEventListener('wpcf7submit', function (event) {
    ...
    for (var i = 0; i < inputs.length; i++) {
      formData.fields.push({
        'name': inputs[i].name.replace('[]', ''),
        'value': inputs[i].value
      });
    }

    var request = new XMLHttpRequest();
    var url = "https://api.hsforms.com/submissions/v3/integration/submit/".concat(form.dataset.portal, "/").concat(form.dataset.form);
    ...
    request.onreadystatechange = function () {
      if (request.readyState === XMLHttpRequest.DONE) {
        ...
        if (request.status !== 200) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('Ooops!', JSON.parse(request.responseText).message || 'Error', 'error');
        } else {
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('Delicious', JSON.parse(request.responseText).inlineMessage, 'success');
        }
      }
    };
  ...
  var _loop = function _loop(i) {
    next[i].addEventListener('click', function (event) {
      event.preventDefault();
      var currentPart = next[i].closest('.form-part');
      var nextPart = currentPart.nextElementSibling;
      var required = currentPart.querySelectorAll('.wpcf7-validates-as-required');
      var hasErrors = false;

      for (var _i = 0; _i < required.length; _i++) {
        var field = required[_i].closest('.form-item');
        ...
        if (!required[_i].value) {
          field.classList.add('has-errors');
          field.innerHTML += '<div class="error">This field is required.</div>';
          hasErrors = true;
        }

        if (required[_i].value && required[_i].type === 'email' && !validateEmail(required[_i].value)) {
          field.classList.add('has-errors');
...
function initMenus() {
  var navItems = document.querySelectorAll('.js-hoverable');
  var hover = document.querySelector('.js-hover');

  var _loop2 = function _loop2(i) {
    navItems[i].addEventListener('mouseover', function (event) {
      hover.style.transform = "translateX(".concat(i * 80, "px)");
    });
  };
...
/***/ 1:
/*!****************************************!*\
  !*** multi ./assets/js/custom/main.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./assets/js/custom/main.js */"./assets/js/custom/main.js");
